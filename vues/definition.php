...
| -------------------------
| DESCRIPTION
|   VUE - Affichage de la page "Définition d'une crise"
|------------------------------------- */
...
<head>
    ...
    <title>Définition d'une crise - Les services de Crises de Lanaudière</title>
...
<body>
    <div class="page-wrap">
        ...
        <section>
            <div id="container">
                <h2>Définition d'une crise</h2>
                <div class="content">
                    <?= $this->modele->getTexte("texteDefinition", "contenudefinition"); ?>
