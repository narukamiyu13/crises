...
| -------------------------
| DESCRIPTION
|   VUE - Affichage de la page "Documents à télécharger"
|------------------------------------- */
...
<head>
    ...
    <title>Documents à télécharger - Les services de Crises de Lanaudière</title>
    ...
    <div class="page-wrap">
        ...
        <section>
            <div id="container">
                ...
                <div class="content">
                    Vous trouverez ici une liste de documents téléchargeables: dépliants informatifs, rapports d'activités annuels, etc.
                ...
                <?php
                    ...
                    foreach($this->modele->getDocuments() as $document) {
                        $cpt++;
                        echo "<h3><a href='".$document['urlDocument']."'>".$document['nomDocument']."</a></h3>
                        <p>".$document['descriptionDocument']."</p>";
                    }
                
                if($cpt == 0) {
                    echo "<h3>Il n'y a aucun document disponible actuellement</h3>";
                }
