...
| -------------------------
| DESCRIPTION
|   VUE - Affichage de la page "Services"
|------------------------------------- */
...
<head>
    ...
    <title>Services - Les services de Crises de Lanaudière</title>
            ...
            <nav>
                <ul>
                    ...
                    <li>
                     ...
                     <li>
                        <p class="current"><a href="services.html">Services</a></p>
                        <ul>
                            <li>
        ...
        <section>
            <div id="container" style="margin-bottom:50px;">
                <div class="content services">
                    <?= $this->modele->getTexte("texteServices","contenuservices"); ?>
