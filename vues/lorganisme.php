...
| -------------------------
| DESCRIPTION
|   VUE - Affichage de la page "L'Organisme"
|------------------------------------- */
...
<head>
    ...
    <title>L'organisme - Les services de Crises de Lanaudière</title>
    ...
    <div class="page-wrap">
        ...
        <section>
            <div id="container">
                <h2>L'organisme</h2>
                <div class="content">
                    <?= $this->modele->getTexte("texteLorganisme", "contenulorganisme"); ?>
