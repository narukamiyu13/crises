...
| -------------------------
| DESCRIPTION
|   VUE - Affichage de la page "Devenir Membre"
|------------------------------------- */
    ...
    <div class="page-wrap">
        ...
        <section class="formulaireAdhesion">
            <div id="container">
                ...
                <div class="content">
                    <p>En plus d'encourager les Services de crise de Lanaudière, devenir membre vous permet d'y jouer un rôle. En adhérant, votre cotisation de <?=$parametres['coutCotisationAdhesion'] ?>$ vous permettra de faire entendre votre voix aux assemblées générales, ainsi qu'aux autres assemblées organisées.</p><br/>
                    <p>Si vous êtes déjà membre et que vous souhaitez renouveller votre adhésion, remplissez <a href="renouveler.html" style="text-decoration:underline">ce formulaire-ci</a>.</p>
                </div>
                <form method="post" action="devenirMembreSuite.html">
