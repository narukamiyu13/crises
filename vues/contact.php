...
| -------------------------
| DESCRIPTION
|   VUE - Affichage de la page "Contacter l'administration"
|------------------------------------- */
...
<head>
    ...
    <title>Contacter l'administration - Les services de Crises de Lanaudière</title>
    ...
    <div class="page-wrap">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                                ...
                                <li><p><a href="historique.html">Historique</a></p></li>
                                <li><p><a href="philosophie.html">Philosophie</a></p></li>
                     ...
                     <li>
                        ...
                        <ul>
                                ...
                                <li><p><a href="services.html#intervention">Intervention Téléphonique</a></p></li>
                                <li><p><a href="services.html#sejours">Séjours de crise</a></p>                                 <p><a href="services.html#relance">Relance Téléphonique</a></p></li>
                    ...
                    <li>
                        ...
                        <ul>
                                ...
                                <li><p><a href="devenirMembre.html">Devenir Membre</a></p></li>
                               <li>  <p><a href="don.html">Faire un Don</a></p></li>
                                 <li><p><a href="emplois.html">Emplois</a></p></li>
        ...
        <section>
            <div id="container">
                ...
                <div class="content">
                    <p>Il est possible de contacter l'administration de diverses manières: </p>
                    <p>Par téléphone, au <?=$parametres['telephoneAdministration'] ?><?= isset($parametres['posteAdministration'])?" poste ".$parametres['posteAdministration'] : ""; ?></p>
                    <p>Par courriel, à l'adresse courriel suivante: <?=$parametres['courrielAdjoint'] ?></p>
                </div>
