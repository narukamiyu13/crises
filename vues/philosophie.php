...
| -------------------------
| DESCRIPTION
|   VUE - Affichage de la page "Philosophie"
|------------------------------------- */
...
<head>
    ...
    <title>Philosophie - Les services de Crises de Lanaudière</title>
...
<body>
    <div class="page-wrap">
        ...
        <section>
            <div id="container">
                <h2>Philosophie d'intervention</h2>
                <div class="content">
                    <?= $this->modele->getTexte("textePhilosophie", "contenuphilosophie"); ?>
