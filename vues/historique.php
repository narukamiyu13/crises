...
| -------------------------
| DESCRIPTION
|   VUE - Affichage de la page "Historique"
|------------------------------------- */
...
<head>
    ...
    <title>Historique - Les services de Crises de Lanaudière</title>
        ...
        <header>
            ...
            <nav>
                <ul>
                    ...
                    <li>
                        <p class="current"><a href="lorganisme.html">L'organisme</a></p>
                        <ul>
                            <li>
        ...
        <section>
            <div id="container">
                ...
                <div class="content">
                    ...
                    foreach($this->modele->getHistorique() as $evenement) {
                        echo "<div class='evenement'>
                                <h3>".$evenement['moisEvenementHistorique']." ".$evenement['anneeEvenementHistorique']."</h3>
                                <p>".$evenement['descEvenementHistorique']."</p>
