...
| -------------------------
| DESCRIPTION
|   VUE - Affichage de la page "Admissibilité"
|------------------------------------- */
...
<head>
    ...
    <title>Admissibilité - Les services de Crises de Lanaudière</title>
    ...
    <div class="page-wrap">
                     ...
                     <li>
                        ...
                        <ul>
                            <li>
                                ...
                                <p><a href="services.html#sejours">Séjours de crise</a></p>
                                <p><a href="services.html#relance">Relance Téléphonique</a></p>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <p class="current"><a href="admissibilite.html">Admissibilité</a></p>
                        <ul>
                            <li>
        ...
        <section>
            <div id="container">
                <h2>Admissibilité</h2>
                <div class="content">
                    <?= $this->modele->getTexte("texteAdmissibilite", "contenuadmissibilite"); ?>
