...
<head>
    ...
    <title>Les services de Crises de Lanaudière</title>
...
<body>
    <div class="page-wrap">
        ...
        <section>
            <div id="container">
                <h2>Les Services de crise de Lanaudière</h2>
                <div class="content">
                    
                    <?= $this->modele->getTexte("texteAccueil", "contenuaccueil"); ?>
                ...
                <p style="text-align:center;
                          margin-top:15px;">Veuillez noter que les demandes de services se font uniquement par téléphone.</p>
            </div>
        </section>
        </div>
    <footer>
